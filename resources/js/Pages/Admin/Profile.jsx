        ...
        <AdminLayout title="الحساب">
            ...
            <form onSubmit={submit} className="bg-white rounded-2xl border border-cream-3 p-5 max-w-md space-y-4">
                ...
                <button disabled={processing}
                    className="bg-ink text-white px-6 py-2.5 rounded-xl font-bold text-sm hover:bg-gold transition-colors disabled:opacity-60">
    ...
    return (
        <div>
            ...
            <input type={type} value={value} onChange={e => onChange(e.target.value)}
                className="w-full px-3 py-2 border-2 border-cream-3 rounded-xl text-sm focus:border-gold outline-none font-cairo" />
